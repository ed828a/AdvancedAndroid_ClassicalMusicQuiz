...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
     ...
     * inside: create the MediaSessionCompat object,
     * set the flags for external clients,
    ...
    private void initializeMediaSession(){
        ...
        // Set the available actions on Playback States Builder
        mPlaybackStateBuilder = new PlaybackStateCompat.Builder()
                .setActions(PlaybackStateCompat.ACTION_PLAY |
                            PlaybackStateCompat.ACTION_PAUSE |
                            PlaybackStateCompat.ACTION_SKIP_TO_PREVIOUS);
        // Initialize the Playback State of the MediaSession
        mMediaSession.setPlaybackState(mPlaybackStateBuilder.build());
        // Set the Callbacks on MediaSession
